...
$$ 
(We again write $\otimes$ for $\otimes_A$.) The first map is surjective, the second map is injective by flatness of $A/(x)$ and the third map is bijective. This implies $(x)\otimes A/(x)=0$. The sequence 
$$
