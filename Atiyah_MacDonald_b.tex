...
\end{tikzcd}
$$ 
It is easy to see that $\overline{f_1},\overline{f_2}$ and $\overline i$ are injective, that this implies that $\overline f$ is also injective.
\end{proof}
...
\emph{Proof.} We set $N:=A$ in the previous statement. $\square$
...
Then $\mf a:=\{0\}\times\mathbb Z$ has only one a minimal prime $\{0\}\times\mathbb Q$ and $\mf a$ has no primary decomposition.\bigskip%https://math.stackexchange.com/a/1679116/660
